          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                Chez {import.meta.env.VITE_STORE_TITLE} , notre mission est simple : accompagner les parents dans les plus beaux moments de la vie en leur proposant des produits pratiques, doux, et surtout pensés pour le bien-être de leur bébé
                </p>
              </div>
            </div>
